  ...
  return (
    <div className="flex flex-col justify-center max-w-full bg-white gap-4">
        <div className="mt-8 bg-white flex flex-col justify-center rounded-2xl max-w-full h-[755px]">
               ...
               <div className="mt-20 bg-customGray flex flex-col justify-center rounded-2xl max-w-full">
                      <div className="grid grid-rows-1 md:grid-row-2 gap-12 bg-transparent">
                      <div className="bg-black bg-opacity-30 backdrop-blur-md rounded-2xl shadow-xl flex justify-center gap-6 h-[389px]">
                          <img
                            src={productImages.image9}
                            alt="Veka үйлдвэр"
                            className="w-full h-full rounded-2xl"
                            loading="lazy"
                          />
